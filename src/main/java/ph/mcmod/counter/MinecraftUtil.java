...
public static void print(Object obj) {
	try {
		Objects.requireNonNull(MinecraftClient.getInstance().player, "player").sendMessage(new LiteralText(JavaUtil.toString(obj)), false);
	} catch (Throwable e) {
		e.printStackTrace();
		System.out.println("[" + MainKt.NAMESPACE + ":DEBUG]" + JavaUtil.toString(obj));
	}
}
